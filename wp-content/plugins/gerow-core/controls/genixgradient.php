...
/**
 * Class Group_Control_GenixGradient
 * @package GenixCore\Elementor\Controls
 */
class Group_Control_GenixGradient extends Group_Control_Base {
    ...
    public function init_fields() {
        ...
        $fields['color_type'] = [
            ...
            'options' => [
                'classic' => [
                    'title' => _x( 'Solid', 'Text Color Control', 'genixcore' ),
                    'icon' => 'fa fa-paint-brush',
                ],
                'gradient' => [
                    'title' => _x( 'Gradient', 'Text Color Control', 'genixcore' ),
                    'icon' => 'fa fa-barcode',
                ],
            ],
            'default' => 'classic'
        ...
        $fields['color'] = [
            ...
            'default' => '',
            'title' => _x( 'Text Color', 'Background Control', 'genixcore' ),
            'selectors' => [
        ...
        $fields['color_b'] = [
            'label' => _x( 'Second Color (No effect for custom SVG)', 'Background Control', 'genixcore' ),
            'type' => Controls_Manager::COLOR,
            'default' => '#f2295b',
            'condition' => [
                'color_type' => [ 'gradient' ],
