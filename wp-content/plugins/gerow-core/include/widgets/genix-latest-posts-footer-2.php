...
Class Latest_posts_footer2_Widget extends WP_Widget{
	...
	public function widget($args, $instance){
     	...
     	<?php endif; ?>
	     	...
	     	<div class="genix-footer-news genix-footer-news-three">
				...
				?>
		            <div class="genix-footer-news-single genix-footer-news-three-single mb-10">
		                <div class="genix-footer-news-three-single-img bg-blend">
		                    <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('thumbnail'); ?></a>
		                </div>
		                <div class="genix-footer-news-three-single-text">
