<?php
Class Genix_Services_List_Widget extends WP_Widget{

	public function __construct(){
		parent::__construct('genix-services-list', 'Genix Services List', array(
			'description'	=> 'Genix Services List'
		));
	}
...
add_action('widgets_init', function(){
	register_widget('Genix_Services_List_Widget');
});